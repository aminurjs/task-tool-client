    ...
    <section className="bg-gray-100 py-12">
      <div className="container mx-auto text-center">
        <h2 className="text-3xl font-bold mb-6 text-black">
          <span>Who Can Benefit From Our Platform?</span><p className="h-1 w-40 bg-blue-600 mx-auto"></p>
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3  gap-8 p-6">
          ...
          >
            <h3 className="text-xl font-semibold mb-4 text-blue-600">Developers</h3>
          ...
          <div
            ...
            className="bg-white p-6 rounded-md shadow-md"
          >
            <h3 className="text-xl font-semibold mb-4 text-blue-600">Bankers</h3>
            <p className="text-gray-700">
          ...
          <div
            ...
            className="bg-white p-6 rounded-md shadow-md"
          >
            <h3 className="text-xl font-semibold mb-4 text-blue-600">Students</h3>
            <p className="text-gray-700">
          ...
          <div data-aos="zoom-in" className="bg-white p-6 rounded-md shadow-md">
            <h3 className="text-xl font-semibold mb-4 text-blue-600">Entrepreneurs</h3>
            <p className="text-gray-700">
          ...
          <div
            ...
            className="bg-white p-6 rounded-md shadow-md"
          >
            <h3 className="text-xl font-semibold mb-4 text-blue-600">Freelancers</h3>
            <p className="text-gray-700">
