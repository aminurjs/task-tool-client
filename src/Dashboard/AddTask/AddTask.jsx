    ...
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex gap-5">
          ...
          <div className="flex-1">
            <input
              className="bg-slate-300  text-black p-3 rounded w-full outline-none"
              type="text"
              name="title"
        ...
        <div className="my-5">
          <textarea
            className="w-full  resize-none  outline-none bg-slate-300  text-black p-2 rounded"
            name="descriptions"
            rows="10"
        ...
        <div className="my-5">
          <input
            className="bg-blue-600 rounded-md py-2 px-6 text-white font-semibold text-xl cursor-pointer"
            type="submit"
            value="Create Task"
          />
        </div>
